...
def run_optuna():
    ...
    print(f"Total number of trial for this search space: {total_trials}")

    study = optuna.create_study(
        storage="sqlite:///grid_search_27_nov.db",
        study_name="GridSearch_withASHA_27_nov",
    ...
    fig1.write_image("Images/GRID/ASHA/optimization_history_27_nov.png")


    fig2 = optuna.visualization.plot_timeline(study)
    fig2.show()

    fig2.write_image("Images/GRID/ASHA/timeline_27_nov.png")
