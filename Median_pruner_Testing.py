...
def plot_training_validation_loss(epochs, train_losses, val_losses):
    ...
    plt.grid(True)
    #plt.show()
    plt.savefig("Results/TPE/Ranges_dec_11_2/MEdian_AGG/MedianPrunerRanges_AAG.png")
...
def run_optuna(num_samples=NUM_SAMPLES):
    ...
    study = optuna.create_study(
        #storage= "sqlite:///medianpruner_ranges_Split5_dec11_AAG.db",
        #study_name="Medianpruner_ranges_Split5_dec11_AAG",
    ...
    best_checkpoint_path = os.path.join(INSTANCE_DIR, f"best_checkpoint_trial_{best_trial.number}/model.pth")
    ...
    #fig1.show()
    fig1.write_image("Results/TPE/Ranges_dec_11_2/MEdian_AGG/optimization_history_Split5_median_ranges_AAAG.png")

    fig2 = optuna.visualization.plot_timeline(study)
    #fig2.show()
    fig2.write_image("Results/TPE/Ranges_dec_11_2/MEdian_AGG/timeline_Split5_median_ranges_AAG.png")
