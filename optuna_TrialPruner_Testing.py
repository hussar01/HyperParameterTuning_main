...
def plot_training_validation_loss(epochs, train_losses, val_losses):
    ...
    plt.grid(True)
    #plt.show()
    plt.savefig("Results/TPE/Ranges_dec_11_2/SHP/SHP_Ranges_split5_2.png")
...
def run_optuna(num_samples=NUM_SAMPLES):
    ...
    study = optuna.create_study(
        storage= "sqlite:///Ashapruner_SHP_dec205split_ranges_3.db",
        study_name="Ashapruner_SHP_dec205split_ranges_3",
    ...
    #fig1.show()
    fig1.write_image("Results/TPE/Ranges_dec_11_2/SHP/optimization_history_SHP_dec115split_Ranges.png")

    fig2 = optuna.visualization.plot_timeline(study)
    #fig2.show()
    fig2.write_image("Results/TPE/Ranges_dec_11_2/SHP/timeline_SHP_dec115split_rAnges.png")
